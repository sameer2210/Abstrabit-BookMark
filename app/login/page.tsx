      ...
      <div className="relative grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]">
        <div className="hidden flex-col justify-between px-12 py-14 lg:flex">
          <Link href="/" className="flex items-center gap-3 font-semibold text-lg">
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-primary shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Everything you save should feel easy to find.  keeps your best links tidy and ready for action.
            </p>
          ...
          <div className="glass-panel w-full max-w-md rounded-3xl p-8">
            <div className="mb-6 space-y-2 text-center">
              <div className="flex items-center justify-center gap-2 text-sm font-semibold text-muted-foreground">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-primary shadow-sm">
